        ...
        dcc.Tabs([
            dcc.Tab(
                ...
                children=[
                    ...
                    ], style={'width': 'auto', 'margin': '20px auto', 'border': '1px solid black',
                                'boxSizing': 'border-box',
                                'border-radius': '25px',
                                'overflow': 'hidden',
                                'backgroundColor':'white',
                    ...
                    html.Div([
                        html.Div(
                            dcc.Graph(id='stackedbar-fuel-stock-canton', style={'height': '100%'}),
                            style={
                                'width': '33.333%',
                                'border': '1px solid black',
                                'boxSizing': 'border-box',
                        ...
                        html.Div(
                            dcc.Graph(id='pie-fuel-stock', style={'height': '100%'}),
                            style={
                                'width': '33.333%',
                                'border': '1px solid black',
                                'boxSizing': 'border-box',
